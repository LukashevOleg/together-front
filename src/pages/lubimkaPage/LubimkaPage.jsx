    ...
    return (
        <div className="lubimka-page">
                ...
                <div className="lb-header-row">
                    ...
                    {hasPartner && (
                        <div className="lb-partner-badge" onClick={() => navigate('/partner')}>
                            ...
                            <div className="lb-partner-name">{partner.name}</div>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="lb-scroll">
                ...
                {/* SWIPE HERO */}
                {hasPartner && (
                    <div className="lb-swipe-hero" onClick={() => navigate('/swipe')}>
                        ...
                        <button className="lb-swipe-btn" onClick={e => { e.stopPropagation(); navigate('/swipe'); }}>
                            Начать свайпать
                    ...
                    <div className="lb-section">
                        ...
                        {matches.length === 0 ? (
                            <div className="lb-matches-empty">
                                Пока совпадений нет — свайпайте идеи вместе 💝
                            </div>
                        ) : (
