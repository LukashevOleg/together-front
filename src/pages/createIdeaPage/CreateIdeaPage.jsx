...
export default function CreateIdeaPage() {
    ...
    const canNext = () => {
        if (step === 0) return true;   // фото не обязательно
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const { data: idea } = await api.post('/api/ideas', payload);

            // Если есть фото — загружаем
            if (photoFile) {
                const fd = new FormData();
                fd.append('file', photoFile);
                await api.post(`/api/ideas/${idea.id}/photos`, fd, {
    ...
    return (
        <div className="create-page">
            ...
            <div className="top-bar">
                <button className="btn-back" onClick={() => step > 0 ? setStep(s => s - 1) : navigate(-1)}>
            ...
            <div className="create-scroll">
                ...
                {step === 0 && (
                    <div className="step-panel active">
                        ...
                        <div
                            className={`photo-upload-main ${previewUrl ? 'has-photo' : ''}`}
                    ...
                    <div className="step-panel active">
                        ...
                        <div className="field-group">
                            ...
                            <input
                                ...
                                placeholder="Например: Ужин при свечах на крыше"
                                value={form.title}
                        ...
                        <div className="field-group">
                            ...
                            <div className="cat-chips">
                                {CATEGORIES.map(c => (
                                    <div
                                        key={c.key}
                                        className={`f-chip ${form.category === c.key ? 'on' : ''}`}
                    ...
                    <div className="step-panel active">
                        ...
                        <div className="tag-suggestions">
                            {TAG_SUGGESTIONS.map(tag => (
                                <div
                                    key={tag}
                                    className={`f-chip ${form.tags.includes(tag) ? 'on' : ''}`}
